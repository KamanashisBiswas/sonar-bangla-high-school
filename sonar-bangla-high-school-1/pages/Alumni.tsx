  ...
  return (
    <div className="bg-[#edf9f3] min-h-screen pb-16 text-slate-800">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="flex items-center gap-2 text-xs font-semibold text-slate-500 mb-6">
            ...
            <span className="text-slate-800 font-bold">
              {isBn ? 'প্রাক্তন শিক্ষার্থী পরিষদ' : 'Alumni Association'}
            </span>
          </div>
          ...
          <div className="max-w-xl">
            <div className="inline-flex items-center gap-1.5 bg-emerald-100/90 text-emerald-800 border border-emerald-200/80 px-3.5 py-1 rounded-full text-xs font-black uppercase tracking-wider mb-4 shadow-2xs">
              ...
              <span>{isBn ? 'প্রাক্তন শিক্ষার্থী ও ঐতিহ্য' : 'ALUMNI ASSOCIATION'}</span>
            </div>
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed font-normal">
              {isBn 
                ? 'এস ও এস হারম্যান মেইনার স্কুল খুলনার অফিশিয়াল প্রাক্তন শিক্ষার্থী নেটওয়ার্কে আপনাকে স্বাগতম। ১৯৮৭ সাল থেকে গড়ে ওঠা হাজারো প্রাক্তন শিক্ষার্থীর সুদৃঢ় মেলবন্ধন, পেশাগত নেটওয়ার্ক ও উত্তরসূরিদের অনুপ্রেরণার কেন্দ্র।' 
            ...
            {/* Hero Quick CTA Buttons / Navigation Tabs */}
            <div className="flex flex-wrap items-center gap-3 pt-5">
              <button
                type="button"
                onClick={() => scrollToSection('committee')}
                className={`inline-flex items-center gap-2 font-bold text-xs sm:text-sm py-2.5 px-5 rounded-xl transition cursor-pointer ${
                  activeNavTab === 'committee'
                    ? 'bg-[#004d34] text-white shadow-xs'
                    : 'bg-white hover:bg-slate-50 text-slate-800 border border-slate-300 shadow-2xs hover:shadow-xs'
                }`}
              >
                <ShieldCheck size={16} />
                <span>{isBn ? 'কার্যনির্বাহী পরিষদ' : 'Executive Committee'}</span>
              </button>
              <button
                type="button"
              ...
              >
                <Search size={15} className={activeNavTab === 'directory' ? 'text-emerald-300' : 'text-emerald-700'} />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div id="committee" className="scroll-mt-20">
            <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h2 className="text-lg sm:text-xl font-black text-slate-900">
                    {isBn ? 'কার্যনির্বাহী পরিষদ (২০২৫–২০২৭)' : 'Executive Committee (2025–2027)'}
                  </h2>
                  <p className="text-xs text-slate-500 font-medium">
                    {isBn ? 'অ্যালামনাই অ্যাসোসিয়েশনের পরিচালনায় দায়িত্বরত নির্বাহী নেতৃবৃন্দ' : 'Elected leadership directing Alumni Association operations'}
                  </p>
                </div>
              </div>
              <span className="bg-emerald-100/80 text-emerald-800 border border-emerald-200/60 text-[11px] font-bold px-2.5 py-0.5 rounded-full">
                {isBn ? `${toBanglaNum(EXECUTIVE_COMMITTEE.length)} জন কর্মকর্তা` : `${EXECUTIVE_COMMITTEE.length} Members`}
              </span>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-5">
              {EXECUTIVE_COMMITTEE.map((member) => (
                <div
                  key={member.id}
                  className="bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-200 p-4 sm:p-5 flex flex-col items-center text-center group"
                >
                  {/* Photo with zoom hover */}
                  <div className="w-20 h-24 sm:w-22 sm:h-26 rounded-2xl overflow-hidden mb-3 border border-slate-200 shadow-2xs group-hover:scale-105 transition-transform duration-200 relative bg-slate-100 flex-shrink-0">
                    <img
                      src={member.image}
                      alt={member.name}
                  ...
                  {/* Designation Badge */}
                  <span className="inline-block bg-emerald-50 text-emerald-800 text-[10px] font-black px-2.5 py-0.5 rounded-md mb-1.5 border border-emerald-200/60">
                    {isBn ? member.designationBn : member.designation}
                  </span>

                  {/* Name */}
                  <h3 className="font-bold text-sm text-slate-900 leading-tight group-hover:text-emerald-700 transition-colors">
                  ...
                  {/* Professional Role */}
                  <div className="text-[11px] text-slate-600 font-medium mt-1.5 line-clamp-1">
          ...
          <div id="spotlight" className="scroll-mt-20">
            <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h2 className="text-lg sm:text-xl font-black text-slate-900">
                    {isBn ? 'কৃতি প্রাক্তনীদের পদচিহ্ন' : 'Distinguished Alumni Spotlight'}
                  </h2>
                  <p className="text-xs text-slate-500 font-medium">
                    {isBn
                      ? 'সিভিল প্রশাসন, চিকিৎসা, তথ্যপ্রযুক্তি, গবেষণা ও শিল্পোদ্যোগে অনন্য অবদান'
                      : 'Celebrating graduates who are shaping industries and institutions globally'}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {ALUMNI_DATABASE.filter((a) => a.isDistinguished).map((alumni) => (
                <div
                  key={alumni.id}
                  className="bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all duration-200 p-5 flex flex-col justify-between group"
                >
                  <div>
                    {/* Top Badge & Batch */}
                    ...
                    <div className="flex items-center gap-3.5 mb-3.5">
                      <div className="w-14 h-16 rounded-xl overflow-hidden shrink-0 shadow-2xs border border-slate-200 bg-slate-100 group-hover:scale-105 transition-transform">
                        <img
                          src={alumni.image}
                          alt={alumni.name}
                          className="w-full h-full object-cover object-top"
                      ...
                      <div className="min-w-0">
                        <h3 className="font-bold text-sm text-slate-900 group-hover:text-emerald-700 transition-colors leading-tight truncate">
                    ...
                    {/* Quote Box */}
                    {alumni.quote && (
                      <div className="bg-slate-50 border border-slate-100 rounded-xl p-3 text-xs text-slate-600 italic font-medium leading-relaxed mb-3.5">
                  ...
                  {/* Bottom Meta */}
                  <div className="pt-2.5 border-t border-slate-100 space-y-1 text-[10.5px] text-slate-500 font-medium">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="truncate">{isBn ? alumni.locationBn : alumni.location}</span>
                    </div>
                  </div>
                </div>
              ))}
                      ...
                      <div className="space-y-3">
                        <div className="flex items-start justify-between gap-2">
                          <div className="flex items-center gap-3">
                            <div className="w-12 h-14 rounded-xl overflow-hidden shrink-0 shadow-2xs border border-slate-200 bg-slate-100 group-hover:scale-105 transition-transform">
                              <img
                                src={alm.image}
                                alt={alm.name}
                                className="w-full h-full object-cover object-top"
        ...
        <ScrollReveal duration={0.6} distance={25}>
          <div id="reunion" className="scroll-mt-20">
