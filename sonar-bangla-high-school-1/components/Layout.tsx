...
const Layout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-slate-50 text-slate-800 selection:bg-emerald-100 selection:text-emerald-900">
      ...
      {/* ── Collapsible zone: Top Utility Bar + Logo Header ── */}
      {/* Slides up and out of view when user scrolls down */}
      <div
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-2.5 lg:py-2 xl:py-2.5 2xl:py-3.5 flex justify-between items-center">
            <Link to="/" className="flex items-center gap-3 sm:gap-4 group">
              <img
                ...
                className="h-14 sm:h-16 md:h-18 lg:h-14 xl:h-16 2xl:h-22 w-auto object-contain flex-shrink-0 group-hover:scale-105 transition-transform duration-300"
              />
              <div>
                <h1 className="text-lg sm:text-xl md:text-2xl lg:text-lg xl:text-xl 2xl:text-3xl font-extrabold text-slate-900 tracking-tight leading-tight group-hover:text-emerald-700 transition">
                  {language === "bn"
                    ? settings.schoolName
                    : "SOS HERMANN GMEINER SCHOOL KHULNA"}
                </h1>
                <p className="text-[11px] sm:text-xs lg:text-[11px] xl:text-xs 2xl:text-sm font-semibold text-emerald-700 mt-0.5 2xl:mt-1 tracking-wide">
                  {language === "bn"
            ...
            <div className="hidden lg:flex items-center gap-2">
              <Link
                to="/admission"
                className="bg-emerald-50 hover:bg-emerald-100 text-emerald-700 border border-emerald-200 px-3 py-1.5 lg:px-2.5 lg:py-1.5 xl:px-3 xl:py-2 2xl:px-4 2xl:py-2 rounded-xl text-xs font-bold transition flex items-center gap-1.5 shadow-sm"
              >
                <BookOpen size={14} /> {t.topbar.onlineAdmission}
              </Link>
              <Link
                to="/result"
                className="bg-amber-50 hover:bg-amber-100 text-amber-800 border border-amber-200 px-3 py-1.5 lg:px-2.5 lg:py-1.5 xl:px-3 xl:py-2 2xl:px-4 2xl:py-2 rounded-xl text-xs font-bold transition flex items-center gap-1.5 shadow-sm"
              >
          ...
          <Link to="/" className="flex items-center gap-3 group">
            ...
            <div>
              <h1 className="text-sm font-extrabold text-slate-900 tracking-tight leading-tight">
                {language === "bn" ? settings.schoolName : "SOS HGS KHULNA"}
              </h1>
            </div>
          </Link>
          <div className="flex items-center gap-2">
            {/* Mobile Language Switcher */}
            <div className="bg-slate-100 p-0.5 rounded-lg border border-slate-200 flex items-center shadow-xs">
              <button
                type="button"
            ...
            <button
              ...
              className="text-slate-700 hover:text-emerald-700 p-2 rounded-xl border border-slate-200 hover:bg-slate-50 transition shadow-sm"
            >
      ...
      {/* ── Sticky Green Navbar (desktop only) ── */}
      {/* Always stays at top; shows mini logo when scrolled */}
      <nav
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <div className="w-px h-5 bg-emerald-600 flex-shrink-0" />
            </div>

            <ul className="flex items-center flex-wrap gap-0.5 flex-1">
              {navItems.map((item) => {
                ...
                return (
                  <li key={item.path}>
                    <Link
                      to={item.path}
                      className={`inline-block px-2.5 py-2 lg:px-2 lg:py-1.5 xl:px-2.5 xl:py-2 2xl:px-3.5 2xl:py-3 text-xs lg:text-xs xl:text-[13px] 2xl:text-sm font-semibold transition-all duration-200 relative ${
                        isActive
            ...
            <div className="py-1.5 lg:py-1 xl:py-1.5 2xl:py-2 flex items-center flex-shrink-0">
              <div className="bg-emerald-950/90 p-0.5 rounded-full border border-emerald-700/60 flex items-center shadow-inner">
                <button
                  type="button"
                  onClick={() => language !== "bn" && toggleLanguage()}
                  className={`px-2.5 py-0.5 lg:px-2.5 lg:py-0.5 xl:px-3 xl:py-1 rounded-full text-xs font-black transition-all duration-200 cursor-pointer ${
                    language === "bn"
              ...
              <ul className="space-y-3 text-xs text-emerald-100/90 font-medium">
                ...
                <li>
                  ...
                  >
                    <span className="text-emerald-300">›</span>{" "}
                    {language === "bn"
                      ? "একাডেমিক ফলাফল ও মার্কশিট"
                      : "Academic Results & Marksheet"}
                  </Link>
                </li>
                <li>
                  <Link
