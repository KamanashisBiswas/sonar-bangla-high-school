        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-xl">
            <div className="inline-flex items-center gap-1.5 bg-emerald-100/90 text-emerald-800 border border-emerald-200/80 px-3.5 py-1 rounded-full text-xs font-black uppercase tracking-wider mb-4 shadow-2xs">
              ...
              <span>{language === 'bn' ? 'একাডেমিক কার্যক্রম' : 'ACADEMIC EXCELLENCE'}</span>
            </div>
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed font-normal">
              {language === 'bn' 
                ? 'ক্লাস রুটিন, একাডেমিক নীতিমালা এবং শিক্ষার্থীদের জন্য প্রয়োজনীয় তথ্য ও দিকনির্দেশনা।' 
                : 'Master class routines, curriculum guidelines, and comprehensive academic policies.'}
            </p>
          </div>
