...
const NOTICE_EN_MAP: Record<string, string> = {
  ...
  "এস.এস.সি পরীক্ষা ২০২৫ এর ফলাফল ও মার্কশিট সংগ্রহ":
    "SSC Examination 2025 Results & Marksheet Distribution",
  "প্রেপ-১ ও ৬ষ্ঠ শ্রেণিতে অনলাইন ভর্তি আবেদন কার্যক্রম ২০২৫":
    "Online Admission Open for Prep-1 & Class 6 (Session 2025)",
  "আন্তর্জাতিক মাতৃভাষা দিবস ও বার্ষিক ক্রীড়া উৎসব উদযাপন":
    "International Mother Language Day & Annual Sports Meet",
  "অর্ধ-বার্ষিক ও প্রাক-নির্বাচনী পরীক্ষা ২০২৫ এর সময়সূচি প্রকাশ":
    "Half-Yearly & Pre-Test Exam 2025 Schedule Published",
  "বার্ষিক বিজ্ঞান মেলা ও আইসিটি উদ্ভাবন প্রদর্শনী ২০২৫":
    "Annual Science Fair & ICT Innovation Expo 2025",
  "মাসিক বেতন ও পরীক্ষার ফি পরিশোধের সময়সীমা সংক্রান্ত":
    "Notice Regarding Monthly Tuition & Exam Fee Payment",
  "নতুন শিক্ষাবর্ষে ডিজিটাল আইডি কার্ড ও ইউনিফর্ম বিতরণ":
    "Distribution of Digital Student ID Card & School Uniform",
};
    ...
    () => [
      {
        ...
        title:
          language === "bn"
            ...
            : "Our Modern Campus, Built for the Future",

        category:
          language === "bn"
            ? "ফটো গ্যালারি • ক্যাম্পাস ও সুবিধাসমূহ"
            : "Photo Gallery • Campus & Facilities",
      ...
      },
      {
        ...
        title:
          language === "bn"
            ...
            : "Jayanti 2026 — Glorious Student Triumphs in Sports & Co-Curricular",
        category:
          language === "bn"
            ? "ফটো গ্যালারি • জয়ন্তী ২০২৬"
            : "Photo Gallery • Jayanti 2026",
        link: "/gallery",
      },
      {
        ...
        title:
          language === "bn"
            ...
            : "Jayanti 2026 — Education, Humanity & Fostering Bright Futures",
        category:
          language === "bn"
            ? "ফটো গ্যালারি • অধ্যক্ষ ও জয়ন্তী ২০২৬"
            : "Photo Gallery • Leadership & Jayanti",
        link: "/gallery",
      },
      // {
      //   image: "/hero_slider_4.jpg",
      //   title:
      //     language === "bn"
      //       ? "বিজ্ঞান গবেষণাগারে অনুসন্ধান ও উদ্ভাবনের অভিজ্ঞতা"
      //       : "Exploring Science Through Discovery & Innovation",

      //   category:
      //     language === "bn"
      //       ? "ফটো গ্যালারি • বিজ্ঞান ও উদ্ভাবন"
      //       : "Photo Gallery • Science & Innovation",
      ...
      //   title:
      //     language === "bn"
      //       ? "এস ও এস হারম্যান মেইনার স্কুল খুলনা — মূল একাডেমি ও সবুজ ক্যাম্পাস"
      //       : "SOS Hermann Gmeiner School Khulna — Main Academic Campus & Grounds",
      //   category:
      //     language === "bn"
      //       ? "ফটো গ্যালারি • ক্যাম্পাস ভবন"
      ...
      //   title:
      //     language === "bn"
      //       ? "সুশৃঙ্খল পরিবেশ ও শিক্ষার্থীদের প্রাত্যহিক সমাবেশ"
      //       : "Disciplined Environment & Morning Student Assembly",
      //   category:
      //     language === "bn"
      //       ? "ফটো গ্যালারি • প্রাত্যহিক সমাবেশ"
      ...
      //   title:
      //     language === "bn"
      //       ? "স্মার্ট ডিজিটাল মাল্টিমিডিয়া ক্লাসরুম ও বিজ্ঞান ল্যাব"
      //       : "Smart Digital Classrooms & Hands-on Science Labs",
      //   category:
      //     language === "bn"
      //       ? "ফটো গ্যালারি • ডিজিটাল ল্যাব"
      //       : "Photo Gallery • Digital Labs",
      //   link: "/gallery",
      // },
    ],
    [language],
  ...
  const renderNoticeDate = (dateStr: string) => {
    try {
      ...
      return {
        day: isValid
          ? language === "bn"
            ? dateObj.toLocaleString("bn-BD", { day: "2-digit" })
        ...
        month: isValid
          ? language === "bn"
            ? dateObj.toLocaleString("bn-BD", { month: "short" })
      ...
      return {
        day: language === "bn" ? "০১" : "01",
        month: language === "bn" ? "জানু" : "Jan",
      };
    }
  };
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl shadow-slate-200/70 border border-slate-100/90 p-3 sm:p-4 grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4 md:divide-x md:divide-slate-200/70">
          ...
          >
            ...
            <div>
              <h4 className="font-extrabold text-slate-900 text-sm sm:text-base group-hover:text-emerald-700 transition">
                {language === "bn"
                  ? "শ্রেণি কার্যক্রম ও রুটিন"
                  : "Daily Class Schedule"}
              </h4>
              <p className="text-xs text-slate-500 font-medium mt-0.5">
                {language === "bn"
                  ? "ক্লাস রুটিন ও সময়সূচি দেখুন"
                  : "View routine & class time"}
              </p>
            </div>
          </Link>
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 font-medium mt-0.5">
                {language === "bn"
                  ? "আমরা আপনাকে সহায়তা করতে প্রস্তুত"
        ...
        <section className="mb-16 -mt-2 sm:-mt-4 relative z-10">
          ...
          <div className="text-center mb-8">
            <h3 className="text-xl sm:text-2xl font-black text-emerald-950 tracking-wide uppercase">
              {language === "bn"
                ? "আমাদের মূল ভিত্তি ও ক্যাম্পাস শ্রেষ্ঠত্ব"
                : "OUR CORE PILLARS & CAMPUS EXCELLENCE"}
            </h3>
            ...
            {[
              {
                ...
                desc:
                  language === "bn"
                    ? "আমাদের নিবেদিতপ্রাণ, অভিজ্ঞ ও উচ্চ প্রশিক্ষিত শিক্ষকদের পাঠদান ও দিকনির্দেশনা।"
                    : "Direction by our dedicated, experienced, and highly trained educators.",
                action:
                  language === "bn"
                    ? "শিক্ষকবৃন্দের সাথে পরিচিত হোন →"
                    : "Meet Our Faculty →",
                link: "/faculty-excellence",
                image:
                  "https://images.unsplash.com/photo-1577896851231-70ef18881754?w=800&fit=crop&q=80",
              ...
              },
              {
                title:
                  language === "bn"
                    ? "মাল্টিমিডিয়া স্মার্ট ক্লাসরুম"
                    : "Multimedia Smart Classrooms",
                desc:
                  language === "bn"
                    ? "ডিজিটাল প্রজেক্টর ও উন্নত ভিজ্যুয়াল লার্নিং প্রযুক্তি সমৃদ্ধ আধুনিক ক্লাসরুম।"
                    : "Modern, fully integrated digital projectors and advanced visual learning tech.",
                action:
                  language === "bn"
                    ? "ক্লাসরুম গ্যালারি দেখুন →"
                    : "Explore Classroom Galleries →",
              ...
              },
              {
                title:
                  language === "bn"
                    ? "একাডেমিক সাফল্য ও ঐতিহ্য"
                    : "Academic Excellence & Tradition",
                desc:
                  language === "bn"
                    ? "বোর্ড ও বার্ষিক পরীক্ষায় ধারাবাহিক সাফল্য ও শতভাগ পাসের গৌরবময় ঐতিহ্য।"
                    : "A consistent history of board and annual examination achievements.",
                action:
                  language === "bn"
                    ? "মেধা ও সাফল্য রেকর্ড দেখুন →"
                    : "View Merit Records →",
              ...
              },
              {
                title:
                  language === "bn"
                    ? "নিরাপদ ও সুশৃঙ্খল সবুজ ক্যাম্পাস"
                    : "Safe, Green & Disciplined Campus",
                desc:
                  language === "bn"
                    ? "খুলনার গল্লামারীতে মনোরম, শান্ত ও পরিবেশবান্ধব প্রাকৃতিক সবুজ ক্যাম্পাস।"
                    : "A serene, environment-friendly campus in Gollamari, Khulna.",
                action:
                  language === "bn"
                    ? "ভার্চুয়াল ট্যুর শুরু করুন →"
                    : "Start Virtual Tour →",
                link: "/campus-tour",
                image: "https://soshgskhulna.edu.bd/media/158/Slider-3.jpeg",
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  <span
                    className={`text-[11px] font-bold uppercase tracking-wider px-3 py-1 rounded-full backdrop-blur-md ${card.badgeColor} shadow-md`}
                  >
                    {card.badge}
                  </span>
          ...
          <div className="text-center mt-7">
            ...
            >
              {language === "bn"
                ? "ভর্তি সংক্রান্ত তথ্য (Explore Admissions)"
                : "EXPLORE ADMISSIONS"}
            </Link>
          </div>
        </section>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-slate-500 font-medium mt-1">
                    {language === "bn"
                      ? "ঐতিহ্য, মানবিক মূল্যবোধ ও আধুনিক শিক্ষার মেলবন্ধন"
                      : "Heritage, Human Values & Contemporary Academic Excellence"}
                  </p>
              ...
              <div className="lg:col-span-7 space-y-6">
                <p className="text-xs sm:text-sm text-slate-700 leading-relaxed text-justify">
                  {language === "bn" ? (
                    <>
                      ...
                      ১৯৮৭ সালে খুলনার গল্লামারীতে এস ও এস চিলড্রেন্স ভিলেজ
                      ইন্টারন্যাশনাল দ্বারা প্রতিষ্ঠিত একটি ঐতিহ্যবাহী ও
                      শীর্ষস্থানীয় বিদ্যাপীঠ। মনোরম ও শান্ত প্রাকৃতিক পরিবেশে
                      আধুনিক ডিজিটাল ক্লাসরুম, সমৃদ্ধ বিজ্ঞানাগার, চারিত্রিক
                      নৈতিকতা গঠন ও যুগোপযোগী সহশিক্ষা কার্যক্রমের মাধ্যমে
                      প্রতিটি শিক্ষার্থীকে আলোকিত ও দক্ষ বৈশ্বিক নাগরিক হিসেবে
                      গড়ে তোলাই আমাদের পরম ব্রত।
                    </>
                  ) : (
                    <>
                      <strong className="text-emerald-800 font-extrabold">
                      ...
                      is a premier educational institution founded in{" "}
                      <strong className="text-slate-900 font-extrabold">
                        1987
                      </strong>{" "}
                      at Gollamari, Khulna under SOS Children's Villages
                      International. Nestled in a lush, peaceful campus, the
                      institution combines state-of-the-art multimedia learning,
                      science laboratories, holistic character formation, and
                      dynamic co-curricular activities to prepare learners for
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5">
                  ...
                  <div className="bg-white p-4 rounded-2xl border border-slate-100/90 shadow-sm flex flex-col items-center justify-between text-center hover:shadow-md transition">
                    ...
                    <span className="font-extrabold text-slate-900 text-sm sm:text-base mt-0.5">
                      {toBanglaNum(settings.eiinCode)}
                    </span>
                  </div>
                  ...
                  <div className="bg-white p-4 rounded-2xl border border-slate-100/90 shadow-sm flex flex-col items-center justify-between text-center hover:shadow-md transition">
                    ...
                    <span className="font-extrabold text-slate-900 text-sm sm:text-base mt-0.5">
                      {toBanglaNum(settings.establishedYear || "1987")}
                    </span>
                  </div>
                  ...
                  <div className="bg-white p-4 rounded-2xl border border-slate-100/90 shadow-sm flex flex-col items-center justify-between text-center hover:shadow-md transition">
                    ...
                    <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider block">
                      {language === "bn" ? "শ্রেণি পর্যায়" : "LEVELS"}
                    </span>
                    <span className="font-extrabold text-slate-900 text-sm sm:text-base mt-0.5">
                      {language === "bn" ? "প্লে - ১০ম" : "Play - 10th"}
                    </span>
                  </div>
                  ...
                  <div className="bg-white p-4 rounded-2xl border border-slate-100/90 shadow-sm flex flex-col items-center justify-between text-center hover:shadow-md transition">
                    ...
                    <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider block">
                      {language === "bn" ? "ক্যাম্পাস" : "CAMPUS AREA"}
                    </span>
            ...
            <div className="bg-emerald-50/60 border border-emerald-100/80 rounded-2xl p-5 sm:p-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 items-center">
              ...
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-500 leading-snug mt-0.5">
                    {language === "bn"
                      ? "চরিত্র গঠন, সহানুভূতি ও দায়িত্বশীলতা।"
              ...
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-500 leading-snug mt-0.5">
                    {language === "bn"
                      ? "পড়াশোনা, ক্রীড়া, শিল্প ও জীবনদক্ষতার সমন্বয়।"
                      : "Balancing academics, sports, arts and life skills."}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-500 leading-snug mt-0.5">
                    {language === "bn"
                      ? "আধুনিক বিশ্বের জন্য দক্ষ নাগরিক তৈরি।"
                      : "Preparing learners for a connected world."}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-500 leading-snug mt-0.5">
                    {language === "bn"
                      ? "সহমর্মিতা ও সামাজিক দায়বদ্ধতা চর্চা।"
                      : "Nurturing compassion and social responsibility."}
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5 sm:gap-6">
                  <div className="flex flex-col items-center flex-shrink-0 text-center">
                    ...
                    <h4 className="font-extrabold text-slate-900 text-sm sm:text-base">
                      {language === "bn"
                        ...
                        : PERSON_NAME_EN_MAP[settings.chairmanName || ""] ||
                          "Maksuda Sultana"}
                    </h4>
                    ...
                    <p className="text-[10px] text-slate-400 max-w-[180px] leading-tight mt-0.5">
                      {language === "bn"
                        ? "এসওএস হারম্যান মেইনার স্কুল খুলনা"
                        : "SOS Hermann Gmeiner School Khulna"}
                    </p>
                  </div>
                  ...
                  <div className="text-slate-600 leading-relaxed text-xs sm:text-sm space-y-3 flex-1">
                    <blockquote className="font-medium text-slate-800 bg-amber-50/40 p-3.5 rounded-xl border-l-4 border-amber-500 text-xs sm:text-sm flex items-start gap-2">
                      <span className="text-amber-600 font-serif text-2xl leading-none flex-shrink-0">
                        “
                      </span>
                ...
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5 sm:gap-6">
                  <div className="flex flex-col items-center flex-shrink-0 text-center">
                    ...
                    <h4 className="font-extrabold text-slate-900 text-sm sm:text-base">
                      {language === "bn"
                        ...
                        : PERSON_NAME_EN_MAP[settings.headmasterName || ""] ||
                          "Indrajit Kumar Mondal"}
                    </h4>
                  ...
                  <div className="text-slate-600 leading-relaxed text-xs sm:text-sm space-y-3 flex-1">
                    <blockquote className="font-medium text-slate-800 bg-emerald-50/40 p-3.5 rounded-xl border-l-4 border-emerald-500 text-xs sm:text-sm flex items-start gap-2">
                      <span className="text-emerald-600 font-serif text-2xl leading-none flex-shrink-0">
                        “
                      </span>
                      <p className="italic leading-relaxed">
                        {language === "bn"
            ...
            <div className="flex flex-col justify-between gap-6">
                        ...
                        <div className="flex-grow min-w-0">
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            ...
                            <span className="text-[10px] text-slate-400 font-medium flex items-center gap-1">
                              <Calendar size={10} />{" "}
                              {toBanglaNum(
                                notice.date.split("-").reverse().join("/"),
                              )}
                            </span>
                          </div>
                        </div>
              ...
              <div className="bg-white p-4 sm:p-4.5 rounded-3xl shadow-sm border border-slate-200/90">
                <h3 className="text-xs sm:text-sm font-bold text-slate-900 mb-3 pb-1.5 border-b border-slate-100 flex items-center gap-1.5">
                  ...
                  {language === "bn" ? "প্রয়োজনীয় লিংক" : "Quick Access"}
                </h3>
        ...
        <ScrollReveal duration={0.6} distance={25} className="mb-20 relative">
          ...
          <div className="text-center max-w-2xl mx-auto mb-12 relative z-10">
            <div className="inline-flex items-center gap-2 bg-emerald-50 text-emerald-800 border border-emerald-200/90 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider mb-3">
              ...
              {language === "bn"
                ? "আমাদের লক্ষ্য ও মূল উদ্দেশ্য"
                : "OUR AIM & KEY OBJECTIVES"}
            </div>
          ...
          >
            {[
              ...
              {
                icon: (
                  <Heart size={24} className="text-blue-600 fill-blue-50" />
                ),
              ...
              >
                ...
                <div
                  className={`h-1.5 w-full ${card.topBorder} absolute top-0 left-0`}
                />
                ...
                <div>
                  ...
                  <div
                    className={`w-14 h-14 rounded-full ${card.iconBg} border flex items-center justify-center mb-6 group-hover:scale-105 transition-transform duration-300 shadow-xs`}
                  >
                    {card.icon}
                  </div>
            ...
            <div className="flex items-center justify-between pb-6 mb-8 border-b border-slate-100 gap-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-xl sm:text-2xl font-black text-slate-900 tracking-tight">
                  {language === "bn"
                    ? "ক্যাম্পাস ফটো গ্যালারি ও অ্যালবাম"
                    : "Campus Showcase & Photo Gallery"}
                </h3>
              </div>
              <Link
                to="/gallery"
              ...
              >
                <span>
                  {language === "bn" ? "সকল ছবি দেখুন" : "View Full Gallery"}
                </span>
                <ChevronRight size={16} />
              </Link>
            </div>
              ...
              {[
                {
                  ...
                  title:
                    language === "bn"
                      ? "বার্ষিক ক্রীড়া ও সাংস্কৃতিক অনুষ্ঠান ২০২৫"
                      : "Annual Sports & Cultural Program 2025",
                  date: "18 FEB 2025",
                ...
                },
                {
                  ...
                  title:
                    language === "bn"
                      ? "বিজ্ঞান মেলা ও রোবোটিক্স প্রদর্শনী"
                ...
                },
                {
                  ...
                  title:
                    language === "bn"
                      ? "বার্ষিক পুরস্কার বিতরণী ও কৃতি সংবর্ধনা ২০২৫"
                ...
                },
                {
                  ...
                  title:
                    language === "bn"
                      ? "স্মার্ট ক্লাসরুম ও সহশিক্ষা কার্যক্রম"
                ...
                },
                {
                  ...
                  title:
                    language === "bn"
                      ? "আন্তর্জাতিক মাতৃভাষা দিবস ও প্রভাতফেরি"
                ...
                },
                {
                  ...
                  title:
                    language === "bn"
                      ? "স্কাউট ক্যাম্পুরি ও সামাজিক নেতৃত্ব প্রশিক্ষণ"
                      : "Scout Camporee & Youth Training",
                  date: "12 JAN 2025",
                  dateBn: "১২ জানুয়ারি ২০২৫",
                  photosCount: 14,
                  cover:
                    "https://images.unsplash.com/photo-1472653431158-6364773b2a56?w=800&fit=crop&q=80",
                  stack1: "https://soshgskhulna.edu.bd/media/158/Slider-3.jpeg",
                  stack2: "/hero_slider.jpg",
                },
                {
                  ...
                  title:
                    language === "bn"
                      ? "এস.এস.সি কৃতি শিক্ষার্থী সংবর্ধনা ও সম্মাননা"
                      : "SSC Brilliant Student Reception",
                  date: "25 MAY 2025",
                  dateBn: "২৫ মে ২০২৫",
                  photosCount: 24,
                  cover:
                ...
                },
                {
                  ...
                  title:
                    language === "bn"
                      ? "ক্যাম্পাস বৃক্ষরোপণ অভিযান ও পরিবেশ দিবস"
                      : "Campus Greenery & Tree Plantation",
                  date: "05 JUN 2025",
                  dateBn: "০৫ জুন ২০২৫",
                  photosCount: 12,
                ...
                },
                {
                  ...
                  title:
                    language === "bn"
                      ? "বার্ষিক বনভোজন ও সুন্দরবন শিক্ষাসফর"
                      : "Annual Study Tour & Picnic",
                  date: "28 JAN 2025",
                ...
                },
                {
                  ...
                  title:
                    language === "bn"
                      ? "জাতীয় বই বিতরণ উৎসব ও নবীন বরণ"
                ...
                },
                {
                  ...
                  title:
                    language === "bn"
                      ? "বার্ষিক শিশু চিত্রাঙ্কন ও চারুকলা প্রদর্শনী"
                      : "Children Art & Painting Exhibition",
                  date: "08 APR 2025",
                ...
                },
                {
                  ...
                  title:
                    language === "bn"
                      ? "আন্তঃস্কুল ভলিবল চ্যাম্পিয়নশিপ ও ট্রফি"
                      : "Volleyball Championship Trophy",
                  date: "10 MAR 2025",
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 text-xs font-bold text-emerald-700 mb-1">
                      <span>
                        {language === "bn" ? album.dateBn : album.date}
                      </span>
                    </div>
                    <div className="flex items-center gap-1 text-[11px] text-slate-400 font-medium">
                      ...
                      <span>
                        {language === "bn"
                          ? `${toBanglaNum(album.photosCount)} টি ছবি`
