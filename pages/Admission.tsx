    ...
    <div className="bg-[#edf9f3] min-h-screen pb-16 text-slate-800">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center max-w-2xl mx-auto space-y-2">
            <div className="inline-flex items-center gap-1.5 bg-emerald-100/90 text-emerald-800 border border-emerald-200/80 px-3.5 py-1 rounded-full text-xs font-black uppercase tracking-wider shadow-2xs">
              ...
              <span>{isBn ? 'ভর্তি পোর্টাল ২০২৬' : 'ADMISSION PORTAL 2025'}</span>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6">
              ...
              <div>
                ...
                <input 
                  ...
                  onChange={handleChange} 
                  placeholder={isBn ? 'পিতার পূর্ণ নাম' : 'পিতার পূর্ণ নাম'} 
                  className={inputClass}
                />
              </div>
              ...
              <div>
                ...
                <input 
                  ...
                  onChange={handleChange} 
                  placeholder={isBn ? 'মাতার পূর্ণ নাম' : 'মাতার পূর্ণ নাম'} 
                  className={inputClass}
                />
              </div>
              ...
              <div>
                ...
                <input 
                  ...
                  value={formData.nid} 
                  onChange={handleChange} 
                  placeholder={isBn ? '১০/১৭ ডিজিটের জাতীয় পরিচয়পত্র বা জন্মনিবন্ধন নম্বর' : '১৪ ডিজিটের জাতীয় পরিচয়পত্র নম্বর'} 
                  className={inputClass}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <textarea 
                ...
                onChange={handleChange}
                placeholder={isBn ? 'গ্রাম/রোড, ডাকঘর, উপজেলা, জেলা' : 'গ্রাম/রোড, ডাকঘর, উপজেলা, জেলা'}
                className={inputClass}
              />
            </div>
      ...
      {submitted && lastSubmission && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4 z-50 animate-in fade-in duration-200">
          <div className="bg-white rounded-[32px] max-w-lg w-full p-6 sm:p-8 shadow-2xl border border-slate-100 text-center relative space-y-5">
