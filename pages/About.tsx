  ...
  return (
    <div className="bg-[#edf9f3] min-h-screen pb-16 text-slate-800">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-xl">
            <div className="inline-flex items-center gap-1.5 bg-emerald-100/90 text-emerald-800 border border-emerald-200/80 px-3.5 py-1 rounded-full text-xs font-black uppercase tracking-wider mb-4 shadow-2xs">
              <span>
                {language === "bn" ? "ঐতিহ্য ও ইতিহাস" : "HERITAGE & HISTORY"}
              </span>
            </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ScrollReveal duration={0.6} distance={30}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-4">
                <div className="inline-flex items-center gap-1.5 bg-emerald-50 text-emerald-800 border border-emerald-200/80 px-3 py-1 rounded-xl text-xs font-bold">
                  ...
                  <span>
                    {language === "bn" ? "স্থাপিত: ১৯৮৭" : "ESTD: 1987"}
                  </span>
                </div>

                <h2 className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight">
                  {language === "bn"
                    ? "আমাদের ইতিহাস ও গৌরবময় ঐতিহ্য"
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-5 items-start">
                  <div className="w-24 sm:w-28 flex-shrink-0 text-center sm:text-left">
                    ...
                    <h4 className="font-bold text-slate-900 text-xs sm:text-sm leading-tight">
                      {language === "bn"
                        ? settings.headmasterName || "ইন্দ্রজিৎ কুমার মণ্ডল"
            ...
            <div className="bg-white rounded-3xl p-8 sm:p-10 border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-between">
              <div>
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <span className="text-xs font-black uppercase tracking-wider text-sky-700 block">
                      OUR PURPOSE & VALUES
                    </span>
                    <h3 className="text-2xl sm:text-3xl font-black text-slate-900">
                      {language === "bn"
              ...
              {[
                {
                  ...
                  title:
                    language === "bn"
                      ? "ডিজিটাল কম্পিউটার ল্যাব"
                      : "Digital Computer Lab",
                  desc:
                    language === "bn"
                      ? "হাই-স্পিড ইন্টারনেট ও ৩০+ কম্পিউটার"
                ...
                },
                {
                  ...
                  title:
                    language === "bn"
                      ? "আধুনিক বিজ্ঞান ল্যাব"
                      : "Modern Science Lab",
                  desc:
                    language === "bn"
                      ? "পদার্থ, রসায়ন ও জীববিজ্ঞানের সরঞ্জাম"
                      : "Modern Physics, Chem & Biology kits",
                },
                {
                  icon: BookOpen,
                  color: "text-sky-700 bg-sky-50 border-sky-100",
                  title:
                    language === "bn" ? "সমৃদ্ধ লাইব্রেরি" : "School Library",
                  desc:
                    language === "bn"
                      ? "বইয়ের বিশাল সংগ্রহ ও পড়ার কর্নার"
                      : "Vast collection of books & reading corner",
                },
                {
                  icon: TreePine,
                  color: "text-emerald-700 bg-emerald-50 border-emerald-100",
                  ...
                  desc:
                    language === "bn"
                      ? "ক্রীড়া, শারীরিক শিক্ষা ও সহশিক্ষা প্রাঙ্গণ"
                ...
                >
                  <div
                    className={`w-10 h-10 rounded-xl ${facility.color} flex items-center justify-center flex-shrink-0 shadow-xs border`}
                  >
